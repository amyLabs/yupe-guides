...
!!! danger "Важно!"
    Если вы не знакомы с фреймворком [Yii](http://www.yiiframework.com/doc/guide/1.1/ru/quickstart.what-is-yii), то для более легкого понимания материала, рекомендую вам ознакомиться с шаблоном проектирования [MVC](http://www.yiiframework.com/doc/guide/1.1/ru/basics.mvc), [модулями](http://www.yiiframework.com/doc/guide/1.1/ru/basics.module) фреймворка, а еще лучше - изучить учебное пособие по [созданию блога](http://www.yiiframework.com/doc/blog/1.1/ru).
...
Возникшие вопросы можно задать на нашем [форуме](https://talk.yupe.ru).
...
!!! note "Обратите внимание!"
    Для большего понимания материала, мы не будем использовать генератор кода (Gii), а создадим каждый файл и директорию вручную. Конечно, в будущем вы можете использовать его для упрощения работы. Прочитать как это сделать, можно [здесь](http://www.yiiframework.com/doc/guide/1.1/ru/topics.gii).
...
Детально изучить созданные файлы вы можете в [этом коммите на GitHub](https://github.com/sabian/yupe-todo/commit/4ee5d8b316279d2c27c5a536b7fd4033be94db01). А если возникли вопросы, то смело задавайте их на нашем [форуме](https://talk.yupe.ru). Будем рады помочь!

## Миграции
Теперь пришло время задуматься над структурой таблицы модуля и создании миграции. О том, что такое миграции, для чего они нужны и как с ними работать, вы можете прочитать в [официальном руководстве](http://www.yiiframework.com/doc/guide/1.1/ru/database.migration).
...
## Модель
Учитывая, что официальное руководство по Yii фреймворку предоставляет исчерпывающую информацию о [моделях](http://www.yiiframework.com/doc/guide/1.1/ru/basics.model), их [создании](http://www.yiiframework.com/doc/guide/1.1/ru/form.model) и [работе с базой данных](http://www.yiiframework.com/doc/guide/1.1/ru/database.overview), лучше сразу перейти к делу.
...
Если у вас возникли вопросы по предыдущим шагам руководства, то можете смело задавать их на [форуме](https://talk.yupe.ru). Возможно, это поможет нам дополнить руководство и сделать его более понятным.
...
Код этой части модуля доступен по [ссылке](https://github.com/sabian/yupe-todo/commit/3f4478ab1e79f704ec59f9316573a0fb8eed1745). Если у вас возникли вопросы, можете смело задавать их на нашем [форуме](https://talk.yupe.ru).
...
На этом работу над модулем можно считать завершенной. Изложенного выше материала должно хватить для понимания базовых принципов создания модулей для CMS Юпи! 
